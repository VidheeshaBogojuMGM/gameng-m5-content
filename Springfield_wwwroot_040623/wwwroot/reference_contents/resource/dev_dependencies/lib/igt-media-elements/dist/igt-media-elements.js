/*! igt-media-elements - v5.3.1 - 2019-07-08 */// ---- igt-media-elements library ----
...
var IGTMediaElements = function (IGTMediaElements) {
  ...
  //Mock for getMobilePin method (MFIVE-9894)
  IGTMediaElements.getMobilePin = function() {
...
var IGTMediaElements = function (api, pubSub, util) {
    ...
    var subscribeFullScreenState = function subscribeFullScreenState() {
        return new Promise(function (resolve) {
            ...
            util.registerListener(FULL_SCREEN_STATE, handler);
        });
    };
    ...
    */
     ...
     */
    api.getServerAddresses = function (serverAddresses) {
        util.sendMessage({
...
IGTMediaElements.w2gAccrual = function (pubSub, util) {
     ...
     */
    w2gAccrual.requestAttendant = function () {
        return new Promise(function (resolve) {
            util.sendMessage({
