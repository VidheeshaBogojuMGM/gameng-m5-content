        ...
        notify: {
            handler: function (n) {
                if (n && n.value){
                    ...
                    if(_value>100){
                        this.item = {head:"YOU HAVE EXCEEDED THE BUDGET YOU SET FOR THE "+n.type, message:""};
                    }else if(_value<100){
                        this.item =  {head:"YOU ARE APPROACHING THE BUDGET YOU SET FOR THE "+n.type, message:""};
                    }else{
                        this.item =  {head:"YOU HAVE REACHED THE BUDGET YOU SET FOR THE "+n.type, message:""};
                    }
                }
            },
            immediate: true
