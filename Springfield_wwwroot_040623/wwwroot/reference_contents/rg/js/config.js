...
var responsibleGamingConfig= {
    ...
    sessionScreenUrl:'http://10.182.0.40/reference_contents/spa_session_screen.html#/',                                    //Url where to go after exit RG App, SESSION_SCREEN url is recommend,default is 'http://localhost/patron/index.html'.
    idleScreenUrl:'http://10.182.0.40/reference_contents/idle_screen.html',                                       //Url where to go after for uncarded player to exit RG App, idle url is recommend,default is 'http://localhost/idle/index.html'.
