if (typeof DedicatedWorkerGlobalScope !== 'undefined') {
  ...
  var configuration={
    ...
    rgM5ContentServerHost:'http://10.182.0.40',       //Responsible Gaming M5 Content Host IP
    ...
    notificationUrlMap:'/reference_contents/rg/notification.html',            //Base Url for Responsible Gaming M5 Content
    reminderUrlMap:'/reference_contents/rg/index.html',                       //Base Url for Responsible Gaming M5 Content
